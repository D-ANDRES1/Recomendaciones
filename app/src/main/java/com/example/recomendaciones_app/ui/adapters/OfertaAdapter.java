...
public class OfertaAdapter extends RecyclerView.Adapter<OfertaAdapter.OfertaViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OfertaViewHolder holder, int position) {
        ...
        // Anotación: FUNCIONALIDAD AÑADIDA. Lógica para el badge de descuento.
        if (discountPercentage > 0) {
            holder.tvDiscountBadge.setVisibility(View.VISIBLE);
            holder.tvDiscountBadge.setText(String.format(context.getString(R.string.discount_badge_format), (int)discountPercentage));
        } else {
    ...
    public static class OfertaViewHolder extends RecyclerView.ViewHolder {
        ...
        // Anotación: FUNCIONALIDAD AÑADIDA. Vinculación del nuevo TextView del badge.
        ...
        public OfertaViewHolder(@NonNull View itemView) {
            ...
            tvDiscountBadge = itemView.findViewById(R.id.tvOfertaDiscountBadge);
        }
    }
}
