...
public class ProductoDetalleActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_IS_OFERTA = "extra_is_oferta";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isOferta = getIntent().getBooleanExtra(EXTRA_IS_OFERTA, false);
        ...
        if (producto != null) {
            ...
            // Lógica para mostrar precios de oferta
            setupPrecio(isOferta);
            ...
            btnAnadirCarrito.setOnClickListener(v -> {
                // Antes de añadir al carrito, marcamos si se añadió como oferta.
                producto.setFueAnadidoComoOferta(isOferta);
    ...
    private void setupPrecio(boolean isOferta) {
        ...
        // Solo aplicamos la lógica de oferta si el flag es true Y el producto tiene descuento
        if (isOferta && discountPercentage > 0) {
